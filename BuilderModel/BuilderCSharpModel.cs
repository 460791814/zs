...
namespace BuilderModel
{
    ...
    /// Model代码生成组件
    /// </summary>
    public class BuilderCSharpModel : IBuilderModel
    {        
        #region 公有属性
        protected string _modelname=""; //model类名
        protected string _namespace = ""; //顶级命名空间名
        protected string _modelpath= "Model";//实体类的命名空间
        ...
        public Hashtable Languagelist
        {
            get
            {
                return CodeHelper.Language.LoadFromCfg("BuilderModel.lan");
            }
        }
        #endregion
        ...
        {           
            ...
            strclass.AppendSpace(1, "public partial class " + _modelname);
            if (!string.IsNullOrEmpty(BaseClass))
            {
                strclass.Append(":" + BaseClass);
            }
            strclass.AppendLine("");
